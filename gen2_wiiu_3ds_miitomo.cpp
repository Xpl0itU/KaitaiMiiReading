...
gen2_wiiu_3ds_miitomo_t::gen2_wiiu_3ds_miitomo_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent, gen2_wiiu_3ds_miitomo_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
    m__root = this;
    m_system_id = 0;
    m_avatar_id = 0;
...
void gen2_wiiu_3ds_miitomo_t::_read() {
    ...
    m__io->align_to_byte();
    m_system_id = new std::vector<uint8_t>();
    const int l_system_id = 8;
    for (int i = 0; i < l_system_id; i++) {
        m_system_id->push_back(m__io->read_u1());
    }
...
void gen2_wiiu_3ds_miitomo_t::_clean_up() {
    if (m_system_id) {
        delete m_system_id; m_system_id = 0;
    }
    if (m_avatar_id) {
